...
<html lang="en">
  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <script>
        ...
        // Format the number as currency with dots every 3 digits
        ...
        function stripFormatting(form) {
          // Get the input element
          const input = form.querySelector('#numberInput');
          
          // Remove the dots to get the raw number
          const rawValue = input.value.replace(/\./g, '');
          
          // Save the raw value back into the input field before submitting the form
